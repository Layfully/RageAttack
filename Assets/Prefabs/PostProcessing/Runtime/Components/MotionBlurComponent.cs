...
namespace UnityEngine.PostProcessing
{
    ...
    public sealed class MotionBlurComponent : PostProcessingComponentCommandBuffer<MotionBlurModel>
    {
        ...
        private ReconstructionFilter reconstructionFilter
        {
            get { return m_ReconstructionFilter ?? (m_ReconstructionFilter = new ReconstructionFilter()); }
        }

        FrameBlendingFilter m_FrameBlendingFilter;

        private FrameBlendingFilter frameBlendingFilter
        {
            get { return m_FrameBlendingFilter ?? (m_FrameBlendingFilter = new FrameBlendingFilter()); }
        }
