...
namespace UnityEditor.PostProcessing
{
    ...
    public class MotionBlurModelEditor : PostProcessingModelEditor
    {
        ...
        class GraphDrawer
        {
            ...
            readonly Texture m_BlendingIcon;

            readonly GUIStyle m_LowerCenterStyle;
            readonly GUIStyle m_MiddleCenterStyle;

            readonly Color m_ColorDark;
            readonly Color m_ColorGray;
