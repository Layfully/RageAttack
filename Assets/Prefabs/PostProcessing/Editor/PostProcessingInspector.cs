...
namespace UnityEditor.PostProcessing
{
    ...
    {
        static readonly GUIContent s_PreviewTitle = new GUIContent("Monitors");
        ...
        readonly Dictionary<PostProcessingModelEditor, PostProcessingModel> m_CustomEditors = new Dictionary<PostProcessingModelEditor, PostProcessingModel>();

        private bool IsInteractivePreviewOpened { get; set; }
